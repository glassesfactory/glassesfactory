...
package net.glassesfactory.display
{
	...
	public class GFMeganeSprite extends Sprite
	{
		/*/////////////////////////////////
		* public variables
		/*/////////////////////////////////
		...
		* public methods
		...
		//Constractor
		public function GFMeganeSprite()
		{
			super();
			_children = [];
		...
		*----------------------------------------*/
		...
		/**
		 * この GFMeganeSprite に EventListener を登録します。 
		 * @param type:String
...
//			if( type == Event.ENTER_FRAME ){ this.removeEnterFrame( listener ); return; }
		...
		/**
		 * この GFMeganeSprite インスタンスに登録されている EventListener を全て削除 
		 */		
		...
		/**
		 * この GFMeganeSprite インスタンスに子 DisplayObject インスタンスを追加します。  
		 * @param child
		 * @return 
		 * 
		 */		
		...
		/**
		 * この GFMeganeSprite インスタンスの指定された index 位置に子 DisplayObject インスタンスを追加します。  
		...
		/**
		 * この GFMeganeSprite インスタンスに複数の DisplayObject インスタンスをまとめて追加します。
		 * @param args
		...
		/**
		 * この GFMeganeSprite インスタンスの最前面に DisplayObject を追加します。
		...
		/**
		 * この GFMeganeSprite インスタンスの最背面に DisplayObject を追加します。 
		 * @param child:DisplayObject
		 * @return DisplayObject
		 * 
		 */		
		...
		/**
		 * GFMeganeSprite の子リストの指定された index 位置から子 DisplayObject を削除します。 
		 * @param index
		 * @return 
		 * 
		 */		
		...
		/**
		 * GFMeganeSprite の DisplayObjectTree からまとめて子 DisplayObject を削除します。 
		 * @param args
		 * @return 
		 * 
		 */		
		...
		/**
		 * この GFMeganeSprite の DisplayObjectTree に登録されている子 DisplayObject すべてを削除します。 
		 * 
		 */		
		...
		/**
		 * この GFMeganeSprite インスタンスの最前面にある子 DisplayObject を削除します。 
		...
		/**
		 * この GFMeganeSprite インスタンスの最背面にある子 DisplayObject を削除します。 
		 * @return DisplayObject - 削除された DisplayObject 
		 */
		...
		/**
		 * この GFMeganeSprite インスタンスの DisplayObjectTree の最前面にインデックスされている子 DisplayObject を返します。 
		...
		/**
		 * この GFMeganeSprite インスタンスの DisplayObjectTree の最背面にある子 DisplayObject を返します。 
		...
		*--------------------------------------------*/
		 ...
		 * @return GFMeganeSprite
		 */		
		public function setLineWidth( thick:Number = 0 ):GFMeganeSprite
		{
			_thick = thick;
			_g.lineStyle( _thick );
			return this;
		 ...
		 * @return GFMeganeSprite
		 */		
		public function setColor( color:uint = 0):GFMeganeSprite
		{
			_fillCol = color;
			return this;
		}
		 ...
		 * @return GFMeganeSprite
		 */		
		public function setAlpha( alpha:Number = 1 ):GFMeganeSprite
		{
			_fillAlpha = alpha;
			return this;
		}
		 ...
		 * @return GFMeganeSprite
		 */		
		public function setLineStyle( thick:Number = 0, color:uint = 0, alpha:Number = 1 ):GFMeganeSprite
		{
		 ...
		 * 
		 */		
		public function setBitmapLine( bitmap:BitmapData, matrix:Matrix = null, repeat:Boolean = true, smooth:Boolean = false ):GFMeganeSprite
		{
		 ...
		 * @return GFMeganeSprite
		 */		
		public function setGradientLine( colors:Array, alphas:Array, ratios:Array, type:String = GradientType.LINEAR, matrix:Matrix = null, spreadMethod:String = SpreadMethod.PAD, interpolationMethod:String = InterpolationMethod.RGB, focalPointRatio:Number = 0 ):GFMeganeSprite
		{
		 ...
		 * 
		 */		
		public function setShaderLine( shader:Shader, matrix:Matrix = null ):GFMeganeSprite
		{
		 ...
		 * @return GFMeganeSprite
		 */		
		public function setLineStyleFull( thick:Number = NaN, color:uint = 0, alpha:Number = 1, pixelHint:Boolean = false, scaleMode:String = "normal", caps:String = null, joints:String = null, miterLimit:Number = 3 ):GFMeganeSprite
		{
		 ...
		 * @return GFMeganeSprite
		 */		
		public function setFillStyle( color:uint = 0, alpha:Number = 1 ):GFMeganeSprite
		{
			_fillCol = color;
			_fillAlpha = alpha;
			return this;
		 ...
		 * @return GFMeganeSprite
		 */		
		public function clear():GFMeganeSprite
		{
			_g.clear();
			return this;
		}
		 ...
		 * @return GFMeganeSprite
		 */		
		public function line( x0:Number, y0:Number, x1:Number, y1:Number):GFMeganeSprite
		{
			//ふむ…
			_g.moveTo( x0, y0 );
			_g.lineTo( x1, y1 );
		 ...
		 * @return GFMeganeSprite
		 */		
		public function curve( x0:Number, y0:Number, x1:Number, y1:Number, x2:Number, y2:Number ):GFMeganeSprite
		{
			_g.moveTo( x0, y0 );
		 ...
		 * @return GFMeganeSprite
		 */		
		public function fill( color:uint = uint.MAX_VALUE ):GFMeganeSprite
		{
		 ...
		 * @return GFMeganeSprite
		 */				
		public function gradient( colors:Array, alphas:Array, ratios:Array, type:String = GradientType.LINEAR, matrix:Matrix = null, spreadMethod:String = SpreadMethod.PAD, interpolationMethod:String = InterpolationMethod.RGB, focalPointRatio:Number = 0 ):GFMeganeSprite
		{
		 ...
		 * 
		 */		
		public function gradAsObj( params:Object ):GFMeganeSprite
		{
		 ...
		 * @return GFMeganeSprite
		 */		
		public function bitmapFill(bitmapData:BitmapData = null, matrix:Matrix = null, repeat:Boolean = true, smooth:Boolean = false):GFMeganeSprite
		{
		 ...
		 * 
		 */		
		public function shaderFill( shader:Shader = null, matrix:Matrix = null ):GFMeganeSprite
		{
		 ...
		 * @return GFMeganeSprite
		 */		
		public function square(x:Number, y:Number, width:Number, height:Number):GFMeganeSprite
		{
		 ...
		 * 
		 */		
		public function circle( x:Number, y:Number, radius:Number ):GFMeganeSprite
		{
		 ...
		 * 
		 */		
		public function ellipse(x:Number, y:Number, width:Number, height:Number):GFMeganeSprite
		{
		 ...
		 * @return GFMeganeSprite
		 */		
		public function roundRect( x:Number, y:Number, width:Number, height:Number, radius:Number ):GFMeganeSprite
		{
